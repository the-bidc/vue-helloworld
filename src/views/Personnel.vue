  ...
  <div class="container home">
        ...
        <div class="row">
          ...
          <div class="col-3">
            <button
              ...
              :disabled="
                mySearch.personNbr === '' && mySearch.personName === ''
              "
            >
              Search
            </button>
    ...
    <div v-else>
      ...
      <div v-else class="alert alert-info" role="alert">
        Search for results or Click Add New Employee to add a new record
      </div>
    </div>
  </div>
</template>
...
export default defineComponent({
  setup() {
    const myUserDeptAndRole: any = inject("userDeptAndRole"); //this is actually injected from App.vue
    ...
    const addNewPerson = () => {
      ...
      personData.person.dept = myUserDeptAndRole.value.DEPARTMENT_NAME;
      (personData.person.name = ""),
        (personData.person.email = ""),
        (personData.person.address1 = ""),
        (personData.person.address2 = "");
    ...
    const submitSearchForm = () => {
      ...
      const srch_person = {
        ...
        number: "123456",
        email: "mjackson@abc.com",
        dept: "Communications",
        address1: "123 Basic Lane",
        address2: "Apt 30",
      };
